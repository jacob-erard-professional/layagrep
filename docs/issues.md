...
**Type :** Préparation d’évaluation. **Priorité :** Normale. **Phase :** P0–P7. **Statut :** En cours : trois fixtures et 54 questions réparties entre développement et jeu réservé versionné ; protocole v0.1 et annotations en attente de revue S.
